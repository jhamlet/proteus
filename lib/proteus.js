(function (exports) {
    ...
    /**
     * Get all property names for an object, all the way up the prototyep
     * chain.
     * 
    ...
    function getPropertyNames (obj) {
        var keys = O.keys,
            ...
            enumerate = makeEnum.apply.bind(makeEnum, this),
            props = enumerate(keys(obj))
        ;
        
        while ((obj = protoOf(obj))) {
            merge(props, enumerate(keys(obj)));
        }
