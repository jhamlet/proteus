(function (exports) {
    ...
    slice = (function () {
        ...
        return function (list, offset, end) {
     ...
     * @param hidden {boolean} copy hidden properties, default is 'false'
     * @param overwrite {boolean} overwrite properties already defined on
     ...
     * @param props {object} optional, properties to add to the constructors
     *      prototype
     ...
     * object of properties to copy over to the newly created object.  Getters
     * and setters will be preserved.
     * 
    ...
    plainSpec = merge({writable: true}, openSpec);

    /**
     * Utility method for creating plain objects with simple enumerated
     * values.
     * 
     * @method makeEnum
     * @returns {object}
     */
    function makeEnum () {
        return slice(arguments).reduce(function (prev, curr) {
            prev[curr] = curr;
            return prev;
        }, {});
    }
     ...
     * prototype chain.
     * 
     * @param obj {object} object to get property names from
     * @returns {array}
     */
    getPropertyNames = (function () {
        ...
        return function getPropertyNames (obj, hidden) {
            var propNames = O.getOwnPropertyNames,
                keys = O.keys,
                protoOf = O.getPrototypeOf,
                props
            ;
            
            function getKeys (o) {
                return hidden ? propNames(o) : keys(o);
            }
            
            props = enumerate.apply(null, getKeys(obj));
            
            while ((obj = protoOf(obj))) {
                merge(props, enumerate.apply(null, getKeys(obj)));
            }
            
            return getKeys(props);
        };
    }());
     ...
     * prototype chain.
     * 
     * @param obj {object} object to get property descriptor for
     * @param key {string} name of the property to look up
     * @returns {object}
     */
    function getPropertyDescriptor (obj, key) {
        ...
        return obj && O.getOwnPropertyDescriptor(obj, key);
    }
     ...
     * @param obj {object} object to define property on
     * @param list {array} list of arguments to pass to 'defineProperty'
     * @returns {object} the object passed in
     */
    function defineProperties (obj, list) {
        list.forEach(function (args) {
            defineProperty.apply(this, [obj].concat(args));
        });
        return obj;
    }
     ...
     * @param scope {object} optional, object in which the function resides,
     ...
     * @param obj {object} the object to delegate to
     * @param name {string} name of the function to delegate to on 'obj'
     * @param rest {mixed} additional arguments to prepend to the function call
     * @returns {function}
     */
    function delegateMethod (obj, name /*, rest */) {
        ...
        Class: derive(O, {
            self: {
                ...
                make: function (args) {
                    ...
                    this.apply(inst, isArray(args) ? args : slice(arguments));
                    return inst;
                }
            }
        })
